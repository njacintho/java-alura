...
//		lista.sort(comparator);
		...
		// Lambda " -> " transformando o código a classe anonima em uma linha apenas
...
//		};
		...
		lista.forEach((conta) -> System.out.println(conta + ", Nome do titular: " + conta.getTitular().getNome()) ) ;
